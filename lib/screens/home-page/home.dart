...
class _HomeState extends State<Home> {
  ...
  Future<void> getAllItems() async {
    ...
    List<Response> list = await Future.wait(itemsIds.map((itemId) => client.get(
        'https://bookabook.co.za/wp-json/wc/v3/products?category=$itemId&per_page=100&consumer_key=ck_34efa34549443c3706b49f8525947961737748e5&consumer_secret=cs_5a3a24bff0ed2e8c66c8d685cb73680090a44f75&page=1')));
    ...
    return list.map((response) {
      ...
      if (counter == 0) {
        ...
        setState(() {
          ...
          businessManagement = productList
              .where((data) => data.stockStatus == "instock")
              .toList();
        });
      } else if (counter == 1) {
        print('Second');
        ...
        children: <Widget>[
          ...
          new Container(
            ...
            child: Padding(
              ...
              child: Text(
                'View All Categories',
                style: new TextStyle(fontWeight: FontWeight.w900,color: Colors.white),
              ),
            ),
          )
        ],
